<template>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    <div class="widget">
                        <div class="foot-logo">
                            <div class="logo">
                                <a href="index-2.html" title=""><img src="/src/assets/images/logo.png" alt=""></a>
                            </div>
                            <p>
                ...
                <div class="col-lg-2 col-md-4">
                    <div class="widget">
                        ...
                        <ul class="list-style">
                            ...
                            <li><a href="https://wpkixx.com/html/winku/terms.html" title="">terms & Conditions</a>
                            </li>
    ...
    <div class="bottombar">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <span class="copyright">© Civic Pulse {{ new Date().getFullYear() }}. All rights reserved.</span>
                    <i><img src="/src/assets/images/credit-cards.png" alt=""></i>
                </div>
            </div>
        </div>
    </div>
